...
const WhoWeAreSection = () => {
  ...
  const handleScroll = () => {
    setOffsetY(window.scrollY * 0.2); // Adjust for parallax strength
  };
    ...
    <div className="relative bg-about-bg bg-cover bg-center text-white h-screen flex justify-center">
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 bg-black bg-opacity-60 mt-[15vh] p-8 rounded-2xl shadow-lg max-w-5xl h-[50%]">
        ...
        <div className="flex-1 text-left">
          ...
          <button className="flex items-center hover:border-none gap-2 bg-yellow-500 text-black px-6 py-2 rounded-md hover:bg-yellow-300 magra-bold text-2xl font-semibold transition duration-300">
            <svg
        ...
        <motion.div
          ...
          style={{ transform: `translateY(${offsetY}px)` }} // Apply parallax effect
        >
          <img
            src={player1Image}
            alt="Avatar"
